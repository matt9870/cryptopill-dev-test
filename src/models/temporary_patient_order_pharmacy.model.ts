...
const TemporaryPatientOrderPharmacy = sequelize.define(
	"temporarypatient_order_pharmacy",
	{
		id: {
			autoIncrement: true,
	...
	{
		timestamps: true,
		tableName: "temporarypatient_order_pharmacy",
	}
);

export default TemporaryPatientOrderPharmacy;
